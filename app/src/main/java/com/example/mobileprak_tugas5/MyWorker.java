...
public class MyWorker extends Worker {
    ...
    public Result doWork() {
        displayNotification("Selamat! Barang Berhasil Dipesan.", "Terima Kasih Sudah Berbelanja di DEADVAPE Liquid Store");
    ...
    public void displayNotification(String task, String desc) {
        ...
        NotificationCompat.Builder builder = new
                ...
                .setContentText(desc)
                .setSmallIcon(R.drawable.ic_electronic_cigarette)
